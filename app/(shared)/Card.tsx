...
const Card = (props: Props) => {
  const { className, imageHeight, isSmallCard, isLongForm, post } = props;

  // ! If the post is undefined the empty object {} is assigned to the variables.
  const { id, title, author, createdAt, image, snippet } = post || {};

  //  ? Here we formatted the date to date redeable
